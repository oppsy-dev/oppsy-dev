...
import { EventCardDetails } from './EventCardDetails/EventCardDetails';
    ...
    <div className={styles.card}>
      <div className={styles.main}>
        ...
        <div className={styles.bottomRow}>
          ...
          <button
            type="button"
            className={expanded ? `${styles.expandBtn} ${styles.expandBtnOpen}` : styles.expandBtn}
      ...
      {expanded && <EventCardDetails event={event} />}
    </div>
  );
}
