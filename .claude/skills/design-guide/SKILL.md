...
**Project design tokens (landing page)**
```css
:root {
  --bg:          #ffffff;
  ...
  --text-2:      #3f3f46;
  --text-3:      #71717a;
  --accent:      #d97706;   /* amber — primary CTA, links, highlights */
  --accent-2:    #b45309;   /* amber dark — hover state */
  --glow:        rgba(217, 119, 6, 0.10);
  --red:         #e11d48;
  --red-dim:     rgba(225, 29, 72, 0.08);
  --orange:      #dc4f13;
  --orange-dim:  rgba(220, 79, 19, 0.08);
  --green:       #059669;
...
**Base palette**
- Primary background: White (`--bg`: #ffffff)
- Surfaces: Translucent black overlays (`--surface`, `--surface-2`) — not solid grays
- Text colors:
  - Primary: Near-black (`--text`: #0a0a0a)
  - Secondary: Dark zinc (`--text-2`: #3f3f46)
  - Tertiary: Medium zinc (`--text-3`: #71717a)
- Borders: Translucent black (`--border`: rgba(0,0,0,0.08), `--border-2`: rgba(0,0,0,0.13))

**Accent color**
- Amber (`--accent`: #d97706) is the single brand accent
- Hover/active: darker amber (`--accent-2`: #b45309), deep amber (#92400e) for text gradients
- Glow effect for accent highlights: `--glow` rgba(217,119,6,0.10)
- Apply to: primary buttons, links, active states, key icons, focus rings

**Semantic status colors**
- Red / error: `--red` #e11d48, dimmed: `--red-dim`
- Orange / warning: `--orange` #dc4f13, dimmed: `--orange-dim`
- Green / success: `--green` #059669, dimmed: `--green-dim`
...
- No more than 3 color families (neutrals + amber accent + status colors)
- No bright, saturated colors for large areas
- Do NOT use solid gray surfaces — use translucent black overlays instead
...
input:focus {
  outline: none;
  border-color: #d97706; /* --accent */
  box-shadow: 0 0 0 3px rgba(217, 119, 6, 0.10); /* --glow */
}
